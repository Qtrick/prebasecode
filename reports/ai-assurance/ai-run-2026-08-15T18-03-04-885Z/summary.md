# PreBase AI Assurance Report (ai-run-2026-08-15T18-03-04-885Z)

**Timestamp**: 2026-08-15T18:03:04.886Z
**Overall Status**: **PASS**
...
| --- | --- | --- | --- |
| **Google Gemini** | 🟢 Connected | `root-env` | 38 models |
...
| Gemini live model discovery | **PASS** | 206ms | Discovered 50 models, 38 compatible with Agents. |
| Gemini live content generation (gemini-2.5-flash) | **PASS** | 515ms | Received response (0 chars). |
| LinkUp live search query execution | **PASS** | 1473ms | Returned 3 sources successfully. |
...
| `gemini-3.7-flash-video-understanding-eap` | [Confidential] Gemini 3.7 Flash Video Understanding EAP | 1,048,576 tokens | 65,536 tokens |
