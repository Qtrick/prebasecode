...
function makeStreamEvents(model: string): Anthropic.MessageStreamEvent[] {
	...
	return [
		...
		{ type: 'message_delta', delta: { stop_reason: 'end_turn', stop_sequence: null }, usage: { input_tokens: 1, output_tokens: 1, cache_creation_input_tokens: null, cache_read_input_tokens: null, server_tool_use: null, output_tokens_details: null } as Anthropic.MessageDeltaUsage } as Anthropic.MessageStreamEvent,
		{ type: 'message_stop' },
	];
}
