...
const isMagnusDefaultChatAgent = product.defaultChatAgent?.extensionId === 'prebase.magnus'
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		[AgentHostEnabledSettingId]: {
			...
			// PreBase ships Magnus as the default agent — do not enable Copilot CLI agent host by default.
			default: !isWeb && !isMagnusDefaultChatAgent && product.quality !== 'stable',
