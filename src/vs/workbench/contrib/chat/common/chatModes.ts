...
export namespace ChatMode {
	const magnus = ExtensionIdentifier.equals(product.defaultChatAgent?.extensionId, 'prebase.magnus')
		|| ExtensionIdentifier.equals(product.defaultChatAgent?.chatExtensionId, 'prebase.magnus');
	export const Ask = new BuiltinChatMode(ChatModeKind.Ask, 'Ask', magnus
