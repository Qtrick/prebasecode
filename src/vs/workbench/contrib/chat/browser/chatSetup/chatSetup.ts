...
/** True when product.json wires the default chat agent to PreBase Magnus. */
export function isMagnusDefaultChatAgent(): boolean {
	return ExtensionIdentifier.equals(defaultChat.extensionId, 'prebase.magnus')
		|| ExtensionIdentifier.equals(defaultChat.chatExtensionId, 'prebase.magnus');
}
