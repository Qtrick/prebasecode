...
const chatViewContainerTitle = isMagnusDefaultChatAgent()
	? localize2('chat.viewContainer.label.magnus', "Agents")
...
const chatViewDescriptor: IViewDescriptor = {
	...
	name: chatViewContainerTitle,
	canToggleVisibility: false,
	canMoveView: true,
	openCommandActionDescriptor: {
		id: ChatViewContainerId,
		title: chatViewContainer.title,
		mnemonicTitle: isMagnusDefaultChatAgent()
			? localize({ key: 'miToggleAgents', comment: ['&& denotes a mnemonic'] }, "&&Agents")
