...
function isPreBaseMagnusProduct(productService: IProductService): boolean {
	return productService.defaultChatAgent?.extensionId === 'prebase.magnus'
		|| productService.defaultChatAgent?.chatExtensionId === 'prebase.magnus';
}
