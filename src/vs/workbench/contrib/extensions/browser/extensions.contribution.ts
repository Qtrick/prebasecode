	...
	.registerConfiguration({
		...
		properties: {
			...
			[VerifyExtensionSignatureConfigKey]: {
				type: 'boolean',
				description: localize('extensions.verifySignature', "When enabled, extensions are verified to be signed before getting installed. PreBase defaults this off for Open VSX (packages are not Microsoft Marketplace-signed). Set true only if you understand Open VSX signature limitations."),
				default: true,
				scope: ConfigurationScope.APPLICATION,
				included: isNative
			},
