...
import { classifyNodeLayer, computeNodeImportance, type ArchitectureLayerId } from './architectureLayers.js'
import { computeEntryPointDepthGroups } from './dependencyDepth.js'
