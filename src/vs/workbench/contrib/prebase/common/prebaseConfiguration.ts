...
configurationRegistry.registerConfiguration({
	...
	properties: {
		[PreBaseConfigKeys.UiDensity]: {
			...
			default: 'comfortable',
			description: localize('prebase.ui.density', "UI density for PreBase sidebars and panels."),
			deprecationMessage: localize('prebase.ui.density.deprecated', "Reserved — Maps and Runtime do not read this setting. Hidden from PreBase Settings."),
			included: false,
		},
		...
		[PreBaseConfigKeys.UiCompactGraphControls]: {
			type: 'boolean',
			default: false,
			description: localize('prebase.ui.compactGraphControls', "Use compact controls in PreBase Maps."),
			deprecationMessage: localize('prebase.ui.compactGraphControls.deprecated', "Reserved — Maps UI does not read this setting. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiShowStatusItems]: {
			type: 'boolean',
			default: true,
			description: localize('prebase.ui.showStatusItems', "Show PreBase status items in the status bar."),
			deprecationMessage: localize('prebase.ui.showStatusItems.deprecated', "Reserved — no PreBase status-bar items are registered. Hidden from PreBase Settings."),
			included: false,
		},
	}
});
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		[PreBaseConfigKeys.UiCollapseLongSections]: {
			type: 'boolean',
			default: true,
			description: localize('prebase.ui.collapseLongSections', "Collapse long sections in PreBase sidebars by default."),
			deprecationMessage: localize('prebase.ui.collapseLongSections.deprecated', "Reserved — Maps UI does not read this setting. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiSidebarMinWidth]: {
			...
			minimum: 160,
			maximum: 280,
			description: localize('prebase.ui.sidebarMinWidth', "Minimum PreBase sidebar width in pixels."),
			deprecationMessage: localize('prebase.ui.sidebarMinWidth.deprecated', "Reserved — not applied to the workbench sidebar. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiSidebarMaxWidth]: {
			...
			minimum: 300,
			maximum: 560,
			description: localize('prebase.ui.sidebarMaxWidth', "Maximum PreBase sidebar width in pixels."),
			deprecationMessage: localize('prebase.ui.sidebarMaxWidth.deprecated', "Reserved — not applied to the workbench sidebar. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiSidebarLeftWidth]: {
			...
			minimum: 160,
			maximum: 560,
			description: localize('prebase.ui.sidebarLeftWidth', "Default left PreBase sidebar width in pixels."),
			deprecationMessage: localize('prebase.ui.sidebarLeftWidth.deprecated', "Reserved — not applied to the workbench sidebar. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiSidebarCollapsedWidth]: {
			...
			minimum: 32,
			maximum: 56,
			description: localize('prebase.ui.sidebarCollapsedWidth', "Collapsed PreBase sidebar rail width in pixels."),
			deprecationMessage: localize('prebase.ui.sidebarCollapsedWidth.deprecated', "Reserved — not applied to the workbench sidebar. Hidden from PreBase Settings."),
			included: false,
		},
		[PreBaseConfigKeys.UiSidebarInspectorWidth]: {
			...
			minimum: 160,
			maximum: 560,
			description: localize('prebase.ui.sidebarInspectorWidth', "Right inspector panel width in pixels."),
			deprecationMessage: localize('prebase.ui.sidebarInspectorWidth.deprecated', "Reserved — not applied to the workbench sidebar. Hidden from PreBase Settings."),
			included: false,
		},
	}
});
