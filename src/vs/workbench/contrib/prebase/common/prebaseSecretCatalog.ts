...
export const PREBASE_SECRET_CATALOG: readonly PreBaseSecretDescriptor[] = [
	...
	},
	{
		...
		description: 'Hosted discovery credential for hybrid web context. Local BYOK is used only together with Firecrawl.',
	},
	{
		id: 'firecrawl',
		kind: 'tool-provider',
		...
		localEnvNames: ['FIRECRAWL_API_KEY'],
		cloudSecretNames: ['FIRECRAWL_API_KEY'],
		byokStorageKey: 'prebase.magnus.provider.firecrawl.apiKey',
		hostedSecretName: 'FIRECRAWL_API_KEY',
		consumers: ['magnus-web-search'],
		description: 'Hosted page-enrichment credential for hybrid web context. Local BYOK is used only together with LinkUp.',
	},
	{
		id: 'openai',
		kind: 'model-provider',
