...
export const tocData: ITOCEntry<string> = {
	...
	children: [
		...
		{
			id: 'prebase',
			label: localize('prebase', "PreBase"),
			settings: ['prebase.*'],
			children: [
				{
					id: 'prebase/appearance',
					label: localize('prebaseAppearance', "Appearance"),
					settings: [
						'prebase.ui.density',
				...
				{
					id: 'prebase/sidebar',
					label: localize('prebaseSidebar', "Sidebar"),
					settings: [
						'prebase.ui.collapseLongSections',
						'prebase.ui.sidebarMinWidth',
						'prebase.ui.sidebarMaxWidth',
						'prebase.ui.sidebarLeftWidth',
						'prebase.ui.sidebarCollapsedWidth',
						'prebase.ui.sidebarInspectorWidth'
					]
				},
				{
				...
				{
					id: 'prebase/runtime',
					label: localize('prebaseRuntime', "Runtime"),
					settings: ['prebase.runtime.*']
				},
				{
					id: 'prebase/magnus',
