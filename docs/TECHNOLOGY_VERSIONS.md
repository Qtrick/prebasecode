...
| Electron | **42.8.0** (`package.json` + `.npmrc-gyp` target / `ms_build_id=14845705`) | **42.11.1** researched | [GHSA-r4w5-6pfg-jxp5](https://github.com/electron/electron/security/advisories/GHSA-r4w5-6pfg-jxp5), [Electron releases](https://releases.electronjs.org/), VS Code 1.133 packaging metadata | 42.8.0 aligns with VS Code 1.133 checksums; 42.11.1 is latest safe 42.x release | **Installed 42.8.0** (42.11.1 baseline documented; upgrade deferred until custom MS build id checksums generated) | Upgraded 2026-08-09; research baseline 42.11.1 updated 2026-09-04 | Requires full multi-platform checksum manifest and native rebuild before bumping installed runtime |
