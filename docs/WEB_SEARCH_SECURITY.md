...
- Fetch and scrape accept only public `http`/`https` destinations. Localhost, loopback, link-local, and private-network hosts are rejected on both desktop and Edge (Edge is authoritative).
