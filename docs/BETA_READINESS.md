...
Last audit: **2026-09-03** (campaign: Runtime Preview idle session recursion closed + live CURRENT_GREEN on Linux; LA contracts in `assurance:quick` + macos CI; Darwin package/preLaunch fail-closed; live harness follow-up/question/approval/blur+`prebaseForeground`; C3/Focus false greens closed; **full macOS AppKit live CURRENT_GREEN still required** — beta candidate claim still **forbidden**)
