...
Last audit: **2026-08-31** (Project Guidance V2 interoperability: GitHub agents, OpenCode agents/commands, Gemini TOML commands, Cline workflows, Continue rules, hook discovery diagnostics, safe agent profile activation; Code Graph 4-layout modes with legacy radial normalized to organic; 58 graph unit test files verified; 270 Magnus unit tests verified; beta candidate claim still **forbidden**)
...
| BETA-012 | Magnus | Ask/Plan/Edit/Agent + graph tools reliability | Critical | Needs Verification | — | GUI + Magnus ext | Tool smoke | 2026-08-31: Magnus unit suite **270** pass; Project Guidance V2 interoperability with GitHub agents, OpenCode agents/commands, Gemini TOML commands, Cline workflows, Continue rules, hook discovery diagnostics, safe agent profile activation; live `magnus-guidance-smoke` PASS (~12s). Full provider-backed Agent/chat GUI acceptance still open — **not Complete**. | Pre-beta | 2026-07-20 | — |
