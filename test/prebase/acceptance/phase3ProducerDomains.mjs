...
export const DOMAIN_PATHSPECS = {
	...
	'live-activity': [
		...
		'test/prebase/acceptance/magnus-live-activity-state.test.mjs',
	],
...
export const PATH_PREFIX_DOMAINS = [
	...
	['test/prebase/acceptance/magnus-live-activity-state.test.mjs', 'live-activity'],
...
export const PRODUCER_DOMAINS = {
	...
	'temporal-canonical-scale': ['temporal', 'graphs-common', 'network-graph', 'shared-workbench', 'launch-harness'],
...
export const PRODUCER_HARNESS_PATHS = {
	...
	'magnus-live-activity': ['test/prebase/acceptance/prebase-magnus-live-activity-live.mjs', 'test/prebase/acceptance/prebase-magnus-live-activity-static-contract.mjs'],
	...
	'temporal-canonical-scale': ['graphs/scripts/acceptance/temporal-live.mjs'],
...
export const PRODUCER_ESTIMATED_DURATION_MS = {
	...
	'temporal-canonical-scale': 300_000,
