...
export const PHASE3_PRODUCERS = [
	...
	{ id: 'temporal-canonical-scale', artifacts: ['temporal-canonical-scale'], command: ['node', 'graphs/scripts/acceptance/temporal-live.mjs', '--canonical-scale'], timeoutMs: 600_000 },
...
export const PHASE3_REQUIRED_EVIDENCE = [
	...
	{ id: 'temporal-canonical-scale', path: 'temporal/canonical-scale-live.json' },
