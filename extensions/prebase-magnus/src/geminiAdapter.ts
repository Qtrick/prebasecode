...
export const STATIC_FALLBACK_GEMINI_MODELS: readonly NormalizedAIModel[] = [
	...
	},
	{
		...
		description: 'Next-generation features, speed, and real-time streaming capabilities.',
		inputTokenLimit: 1_000_000,
		outputTokenLimit: 65_536,
		capabilities: {
			textGeneration: true,
	...
	},
	{
		...
		description: 'Cost-efficient and fast Gemini model for high-frequency lightweight tasks.',
		inputTokenLimit: 1_000_000,
		outputTokenLimit: 65_536,
		capabilities: {
			textGeneration: true,
