...
function installHeaders() {
	...
	const local = getHeaderInfo(path.join(import.meta.dirname, '..', '..', '.npmrc-gyp'))
		?? getHeaderInfo(path.join(import.meta.dirname, '..', '..', '.npmrc'));
	const remote = getHeaderInfo(path.join(import.meta.dirname, '..', '..', 'remote', '.npmrc-gyp'))
		?? getHeaderInfo(path.join(import.meta.dirname, '..', '..', 'remote', '.npmrc'));
